...
* **Mô hình SVM:** Được cấu hình tối ưu với `learning_rate=0.08`, hệ số regularization cực nhỏ `lambda_param=0.0002` để nới rộng lề phân cách, huấn luyện tinh gọn trong `n_iters=30` epoch để tránh overfit dữ liệu lệch.
...
| :--- | :---: | :---: | :---: |
| **Accuracy (Độ chính xác tổng thể)** | 56.07% | 95.73% | **96.10%** |
| **Precision (Độ chuẩn xác bắt Spam)** | 83.94% | **99.87%** | 99.60% |
| **Recall (Tỷ lệ bắt sạch Spam)** | 14.15% | 91.51% | **92.50%** |
| **F1-Score (Độ cân bằng mô hình)** | 24.21% | 95.51% | **95.92%** |
