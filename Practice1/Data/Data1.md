# Hướng dẫn sử dụng Notebook `Practice1.ipynb`

Tập tin này mô tả các bước thực thi trong `Practice1.ipynb` (xử lý bộ dữ liệu email spam `emails_raw.csv`) và các artifact mà notebook tạo ra nhằm chuẩn bị dữ liệu phục vụ bài toán phân loại email spam và non-spam.
