...
Dự án nhằm xây dựng mô hình **Linear Regression** để dự đoán **doanh số bán lẻ** (`sales_amount_log`) của từng giao dịch dựa trên thông tin sản phẩm, khách hàng và giao dịch.
